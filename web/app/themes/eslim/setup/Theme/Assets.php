...
class Assets {
	...
	public function enqueue_javascript(){
		...
		// Owl Carousel
		wp_register_script('owl', get_template_directory_uri() . '/assets/bower_components/owl.carousel/dist/owl.carousel.min.js', array('jquery'), '', true);
		wp_register_style('owl', get_template_directory_uri() . '/assets/bower_components/owl.carousel/dist/assets/owl.carousel.min.css');
